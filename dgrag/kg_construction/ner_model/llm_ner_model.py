...
from dgrag.kg_construction.langchain_util import init_langchain_model
from dgrag.kg_construction.utils import extract_json_dict, processing_phrases
...
class LLMNERModel(BaseNERModel):
    ...
    Args:
        ...
        model_name_or_path (str): Name of the specific model to use. Defaults to "deepseek-ai/DeepSeek-V3.2".
    ...
    def __init__(
        ...
        model_name_or_path: str = "deepseek-ai/DeepSeek-V3.2",
        ...
        Args:
            llm_api (Literal["openai", "nvidia", "together", "ollama", "llama.cpp"]): The LLM API provider to use.
                Defaults to "openai" for OpenAI-compatible endpoints.
            model_name_or_path (str): Name of the language model to use.
                Defaults to "deepseek-ai/DeepSeek-V3.2".
            base_url (str | None): Base URL of the OpenAI-compatible endpoint.
        ...
        # Backward compatible with older configs that still pass `model_name`.
