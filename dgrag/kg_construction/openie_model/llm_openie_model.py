...
from dgrag.kg_construction.openie_extraction_instructions import (
    ner_prompts,
    openie_post_ner_prompts,
)
from dgrag.kg_construction.utils import extract_json_dict
...
class LLMOPENIEModel(BaseOPENIEModel):
    ...
    def __init__(
        ...
        Args:
            ...
            model_name_or_path (str): Name of the language model to use. Defaults to "deepseek-ai/DeepSeek-V3.2".
